...
@pytest.mark.parametrize(
    ...
    (
        {},
        {"NoCopy": False},
        {"NoCopy": True, "Subpath": "nested"},
        {"NoCopy": True, "DriverConfig": {"Name": "local"}},
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        {"NoCopy": True, "DriverConfig": None},
        {"NoCopy": True, "Labels": {}},
    ),
)
def test_application_policy_canonicalizes_empty_volume_option_defaults(
    volume_options: dict[str, object],
) -> None:
    volume = ResourceRecord(
        "volume",
